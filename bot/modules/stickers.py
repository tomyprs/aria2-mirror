...
def delsticker(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.sticker:
        ...
        msg.reply_text("Sticker deleted!")
    else:
        update.effective_message.reply_text("Please reply to sticker message to del sticker")
...
"""
    update.effective_message.reply_photo(help_string, parse_mode=ParseMode.MARKDOWN)
